import { PrismaClient, Role, CampaignStatus, CollabStatus, PayoutStatus } from '@prisma/client';
...
async function main() {
  ...
  // Collaboration 1: Eric + Lemlist (CONTENT_SUBMITTED)
  ...
  // Collaboration 2: Robin + Leadbay (APPROVED / PAID)
  ...
  // Collaboration 3: Aya + Lemlist (IN_PROGRESS)
